    ...
    <style>
        * {
        ...
        .menu-icon {
            ...
            /* Atur tinggi ikon */
            fill: #2D2669;
            /* Atur warna ikon jika diperlukan */
            flex-shrink: 0;
            /* Pastikan ikon tidak mengecil ketika container diperkecil */
        }
...
<body>
    <div class="sidebar">
        ...
        <a href="rankpres.html" class="menu-item" id="menu-tambah-agenda" onclick="setActiveMenu('rank')">
            <svg class="menu-icon" viewBox="0 0 24 24">
                <path
                    d="M19 3H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zm0 16H5V5h14v14z" />
                <path
                    d="m13.293 6.293-4 4-2.293-2.293-1.414 1.414L8.293 12l1.414 1.414L14 8.414l4.293 4.293 1.414-1.414L13.293 6.293z" />
            </svg>
            Peringkat Mahasiswa
        </a>
    </div>
